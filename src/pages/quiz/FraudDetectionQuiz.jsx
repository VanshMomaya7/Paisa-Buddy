...
const FraudDetectionQuiz = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-600 via-blue-600 to-blue-800 dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 p-4 transition-colors duration-300 w-[100vw]">
