...
const Chatbot = () => {
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      text: "Hi! I'm PaisaBuddy AI. I can help you with financial advice, budgeting tips, and answer your money-related questions. How can I assist you today?",
      sender: "bot",
      timestamp: new Date(),
    },
  ]);
      ...
      >
        ...
        <div className="bg-gradient-to-r from-teal-500 to-blue-600 dark:from-teal-600 dark:to-blue-700 text-white p-4 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h3 className="font-semibold text-lg">PaisaBuddy Chat</h3>
